            ...
            return (
              <Box
                ...
                sx={{
                  p: 1.5,
                  borderRadius: 1,
                  bgcolor: estValide ? 'rgba(76, 175, 80, 0.05)' : 'transparent',
                  border: estValide ? '1px solid rgba(76, 175, 80, 0.3)' : '1px solid rgba(0,0,0,0.1)'
                }}
              >
                {showCheckboxes && (
                  <Checkbox
                ...
                <Box flexGrow={1}>
                  <Typography
                    variant="body1"
                    color={estValide ? 'text.primary' : 'text.secondary'}
                    fontWeight={estValide ? 'medium' : 'regular'}
                  >
